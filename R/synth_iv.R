#' Synthetic outcome significance level for IV regression.
#'@description
#'
#'  `synth_iv()` runs synthetic outcome tests on regressions to test the null hypothesis that
...
synth_iv=function(fm,df,splines,pc_num,
...
eq_sim=as.formula(paste0("sim~",rhs,"+",paste(names(pc),collapse="+"), "|","explan_var~inst_var"))
