#' First stage IV synthetic outcome tests: regress noise explanatory variable on real inst variable
#'
...
#' syn_bch=synth(mobility~racial_seg+single_mom,  opportunity,
#' splines=4, pc_num=3,nSim=100,Parallel=FALSE)
#'
#' synth_table(syn_bch,adjust="BCH")


synth_iv_stage1=function(fm,df,splines,pc_num,
...
lm_res=lm(as.formula(paste("dep_var",paste(names(pc),collapse="+"),sep="~")),
          data=df)
rm(pc)
