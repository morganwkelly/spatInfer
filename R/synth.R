#' Synthetic outcome tests using BCH standard errors.
#'
#'@description
#' `synth()` runs synthetic outcome tests on regressions with BCH standard errors
#' using increasing numbers of clusters
...
#' library(spatInfer)
#' data(opportunity)
#' # Use 100 observations and 100 simulations to speed things up. Turn off parallel processing.
#' set.seed(123)
...
synth=function(fm,df,splines,pc_num,
