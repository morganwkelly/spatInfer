...
Because the 5\% significance level of a t-statistic with two degrees of freedom is 4.3, and the familiar t-statistic of 2 has a p-value of 0.18 we report 95\% confidence intervals and p-values for each variable.
