...
The parameters $c$, $k$ and $p$ are estimated with two commands. The first is `optimal_basis` which includes the formula to be estimated and the name of the data:
```{r basis}
